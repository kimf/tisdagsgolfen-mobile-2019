declare module "react-navigation" {
  ...
  export class FlatList<ItemT> extends React.Component<
    FlatListProps<ItemT> & NavigationInjectedProps
  > {
    /**
  ...
  declare class ScrollViewComponent extends React.Component<
    ScrollViewProps & NavigationInjectedProps
  > {}
  ...
  export function createAppContainer(routeConfigMap: NavigationRouteConfigMap): NavigationContainer;
 ...
 */
  ...
  export type InferProps<T extends React.ComponentType<any>> = T extends React.ComponentType<
    infer P
  >
    ? P
    : never;
  ...
  export function withNavigation<T extends React.ComponentClass<NavigationInjectedProps>>(
    ...
    Omit<InferProps<T>, keyof NavigationInjectedProps> & { onRef?: React.Ref<InstanceType<T>> }
  >;
  ...
  export function withNavigationFocus<T extends React.ComponentClass<NavigationFocusInjectedProps>>(
    ...
    Omit<InferProps<T>, keyof NavigationFocusInjectedProps> & { onRef?: React.Ref<InstanceType<T>> }
  >;
  ...
  export function withNavigationFocus<T = {}, P = NavigationParams>(
    ...
    T & { onRef?: React.Ref<React.Component<T & NavigationFocusInjectedProps<P>>> }
  >;
